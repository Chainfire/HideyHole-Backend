...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY') or 'ohDearSomeoneShouldReallySetThatEnvironmentVariable'
...
# [START staticurl]
# STATIC_URL = '/static/'
STATIC_URL = 'https://storage.googleapis.com/hideyhole-django/static/'
# [END staticurl]
